                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <button type="submit" class="btn btn-default"><a href="/board/notice2">목록</a></button>
                           <button type="reset" class="btn btn-default"><a href="/board/modify2?bno=<c:out value='${board.bno}'/>">관리</a></button>
