                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             동의과학대학교 컴퓨터소프트웨어과
                            <button id="regBtn" type="button" class="btn btn-xs pull-right">게시글 작성</button>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                <c:forEach var="board" items="${list7}">
                                    <tr class="odd gradeX">
                                        <td><c:out value='${board.bno}'/></td>
										<td><a href="/board/FreegetOne?bno=<c:out value='${board.bno}'/>"><c:out value='${board.title}'/></a></td>
	...
	<div class="modal" tabindex="-1" role="dialog">
		...
		<script type="text/javascript">
			...
			$("#regBtn").click(function(){
				self.location = "/board/Freeregister";
			//window.location = "/board/Freeregister";	
			});	
});
		</script>
