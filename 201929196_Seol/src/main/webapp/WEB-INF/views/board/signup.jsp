...
<!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="../resources/vendor/main/favicon_dit.png" />
<meta charset="utf-8">
<meta name="viewport"
...
<link rel="stylesheet" href="../resources/vendor/signin/styles.css">
...
<body class="img js-fullheight"
	style="background-image: url(../resources/vendor/signin/3.jpg);"
				...
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
						<form action="#" class="signin-form">
							...
							<div class="form-group">
								<input id="텍스트" type="text" class="form-control"
									placeholder="Name" required>
							</div>
							<div class="form-group">
								<input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" placeholder="Student / Professor ID"
									required>
							</div>
							<div class="form-group">
								<button type="submit"
									class="form-control btn btn-second submit px-3">SIGN in</button>
							</div>
						</form>
					</div>
				</div>
	...
	<script src="../resources/vendor/signin/js/jquery.min.js"></script>
	<script src="../resources/vendor/signin/js/popper.js"></script>
	<script src="../resources/vendor/signin/js/bootstrap.min.js"></script>
	<script src="../resources/vendor/signin/js/main.js"></script>
	<script defer
